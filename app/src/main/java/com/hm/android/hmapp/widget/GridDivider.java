package com.hm.android.hmapp.widget;
...
public class GridDivider extends RecyclerView.ItemDecoration {
    ...
    public GridDivider(Builder builder) {
        ...
        if (this.builder.mDivider == null) {
            this.builder.mDivider = new ColorDrawable(0x00F23935);
        }
    }
...
//        }
    ...
    public static class Builder {
        ...
        public Builder(Context context, int spanCount) {
            ...
            this.h_spacing = DensityUtils.dip2px(context , 1);
            this.v_spacing = DensityUtils.dip2px(context,1);
        }
